...
import exercicio_1.Exercicio_1;
...
public class Exercicio_2 extends Thread {
	...
	public static void main(String[] args) {
		...
		Exercicio_2 h1 = new Exercicio_2(1);
		Exercicio_2 h2 = new Exercicio_2(2);
		...
		// Cando acaben os fíos, continuamos as operacións no main xa que son secuenciais
		z = m1 + m2;
